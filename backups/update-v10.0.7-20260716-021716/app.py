...
:if ([:len $mainId] = 0) do={
  /radius add address=172.94.94.1 comment="Cloud MAIN" service=ppp,hotspot timeout=3s secret="__MAIN_RADIUS_SECRET__" disabled=no
} else={
  /radius set $mainId address=172.94.94.1 service=ppp,hotspot timeout=3s secret="__MAIN_RADIUS_SECRET__"
}
:if ([:len $bypassId] = 0) do={
  /radius add address=167.172.106.53 comment="Cloud BYPASS" service=ppp,hotspot timeout=3s secret="__BYPASS_RADIUS_SECRET__" disabled=yes
} else={
  /radius set $bypassId address=167.172.106.53 service=ppp,hotspot timeout=3s secret="__BYPASS_RADIUS_SECRET__"
}
